...
void describe('configValidation', () => {
  ...
  void it('should accept dynamic branding override maps', () => {
    const config = {
      application: {
        branding: {
          translationOverrides: {
            '*': {
              ...
              TITLE_LOGIN: 'Enter the Shed'
            },
            de: {
              TITLE_BASKET: 'Muell Tasche'
            },
            TITLE_CONTACT: 'Shed Mail'
          },
          cssVariables: {
  ...
  void it('should fail for invalid dynamic branding override values', () => {
    const config = {
      application: {
        branding: {
          translationOverrides: {
